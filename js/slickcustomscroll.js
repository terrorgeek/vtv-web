    ...
    return this.each( function() {
        ...
        var drag = {
		    ...
		    return [drag.b.width() - drag.s.width() + bounce, drag.id.width() - drag.c.width() - bounce * drag.tickB];
                    ...
                    drag.b.css( { height: drag.id.height(), right: 0, top: 0, position: "absolute","z-index":10 } );
                    drag.c.css( { display: "block", position: "relative", width: drag.id.width() - drag.b.width() - 5 } );
                    drag.s.css( { width: drag.b.width(), top: 0, height: 70, position: "relative" } );
